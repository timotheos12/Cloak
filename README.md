...
3. File Size: 18.2 KB
4. App Size: 1.0 GB
5. Model Size: 350 MB to 5.5 GB

## Installation
1. Download <code>Cloak.zip</code>
2. Extract <code>Cloak.zip</code>
3. Double-click <code>app.py</code>

## Usage
1. Upload your original image.
2. Choose your desired settings.
3. Apply protection and wait.

...
class ProtectorScreen(ttk.Frame):
    ...
    def _build_controls(self, parent) -> None:
        ...
        ttk.Label(settings, text="Higher budget is stronger but visible. More steps is stronger but slower. Smaller step size is stronger but requires more steps. Different seeds produce different noise. CPU is slower but CUDA requires nvidia.\n \nCreated by Timothy M.",
